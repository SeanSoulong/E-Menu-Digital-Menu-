        ...
        <div className="mb-6">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-12 pr-10 py-1.5 text-[14px] font-normal border-2 rounded-xl focus:outline-none focus:ring-2 focus:border-transparent bg-white transition-all duration-200 placeholder-gray-400"
            />
            {searchQuery && (
              <button
                type="button"
